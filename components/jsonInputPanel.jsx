...
const JsonInputPanel = ({ jsonInput, setJsonInput, error, onGenerate, handleReset }) => {
  return (
    ...
    "user": {
        ...
        className="h-96 w-full rounded border-2 border-gray-300 bg-white p-4 font-mono text-sm text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
      />
